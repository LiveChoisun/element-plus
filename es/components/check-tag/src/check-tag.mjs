...
import { checkTagProps, checkTagEmits } from './check-tag2.mjs';
...
var CheckTag = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\check-tag\\src\\check-tag.vue"]]);
