...
import SelectController from './select-controller.mjs';
          ...
          createElementVNode(
            ...
            [
              renderSlot(_ctx.$slots, "header", { date: i18nDate.value }, () => [
                ...
                unref(validatedRange).length === 0 && _ctx.controllerType === "button" ? (openBlock(), createElementBlock(
                  "div",
                  {
                    key: 0,
                  ...
                  2
                )) : unref(validatedRange).length === 0 && _ctx.controllerType === "select" ? (openBlock(), createElementBlock(
                  "div",
                  {
                    key: 1,
...
var Calendar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\calendar\\src\\calendar.vue"]]);
