import { defineComponent, ref, computed, watch, nextTick, provide, openBlock, createBlock, unref, withCtx, withDirectives, mergeProps, withKeys, createElementVNode, normalizeClass, createTextVNode, toDisplayString, createCommentVNode, createVNode, normalizeStyle, vShow } from 'vue';
...
import { colorPickerProps, colorPickerEmits } from './color-picker2.mjs';
...
var ColorPicker = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\color-picker\\src\\color-picker.vue"]]);
