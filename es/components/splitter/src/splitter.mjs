...
import { splitterProps, splitterEmits } from './splitter2.mjs';
...
var Splitter = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\splitter\\src\\splitter.vue"]]);
