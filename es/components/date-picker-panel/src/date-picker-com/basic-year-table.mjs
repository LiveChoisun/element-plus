...
var YearTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\date-picker-panel\\src\\date-picker-com\\basic-year-table.vue"]]);
