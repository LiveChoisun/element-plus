    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          _ctx.$slots["dyb-footer-extra"] ? (openBlock(), createElementBlock("div", _hoisted_14, [
...
var DateRangePickPanel = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\date-picker-panel\\src\\date-picker-com\\panel-date-range.vue"]]);
