  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", null, [
        isPictureCard.value && _ctx.showFileList ? (vue.openBlock(), vue.createBlock(uploadList["default"], {
          key: 0,
        ...
        !isPictureCard.value || isPictureCard.value && !_ctx.showFileList ? (vue.openBlock(), vue.createBlock(
          uploadContent["default"],
          vue.mergeProps({
            key: 1,
            ref_key: "uploadRef",
...
var Upload = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\upload\\src\\upload.vue"]]);
