...
var selectController = require('./select-controller2.js');
          ...
          vue.createElementVNode(
            ...
            [
              vue.renderSlot(_ctx.$slots, "header", { date: i18nDate.value }, () => [
                ...
                vue.unref(validatedRange).length === 0 && _ctx.controllerType === "button" ? (vue.openBlock(), vue.createElementBlock(
                  "div",
                  {
                    key: 0,
                  ...
                  2
                )) : vue.unref(validatedRange).length === 0 && _ctx.controllerType === "select" ? (vue.openBlock(), vue.createElementBlock(
                  "div",
                  {
                    key: 1,
                  ...
                  [
                    vue.createVNode(selectController["default"], {
                      date: vue.unref(date),
...
var Calendar = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\calendar\\src\\calendar.vue"]]);
