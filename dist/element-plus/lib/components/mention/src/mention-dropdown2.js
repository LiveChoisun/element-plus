...
const _sfc_main = vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const filteredAllDisabled = vue.computed(
                    ...
                    vue.renderSlot(_ctx.$slots, "label", {
                      ...
                      return [
                        vue.createElementVNode(
                          "span",
                          null,
                          vue.toDisplayString((_a = item.label) != null ? _a : item.value),
                          1
                        )
                      ];
                    })
          ...
          _ctx.loading ? (vue.openBlock(), vue.createElementBlock(
            ...
            [
              vue.renderSlot(_ctx.$slots, "loading", {}, () => [
                vue.createTextVNode(
                  vue.toDisplayString(vue.unref(t)("el.mention.loading")),
                  1
                )
              ])
            ],
...
var ElMentionDropdown = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\mention\\src\\mention-dropdown.vue"]]);
