  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getCellStyle = (cell) => {
      ...
      style.current = arrays.castArray(props.parsedValue).some(
        (date) => dayjs__default["default"].isDayjs(date) && date.year() === year && date.month() === month
      );
...
var MonthTable = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\date-picker-panel\\src\\date-picker-com\\basic-month-table.vue"]]);
