...
const _sfc_main = vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const { getHoursList, getMinutesList, getSecondsList } = useTimePicker.getTimeLists(
      props.disabledHours,
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock(
        ...
        [
          !_ctx.arrowControl ? (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            { key: 0 },
            vue.renderList(spinnerItems.value, (item) => {
              return vue.openBlock(), vue.createBlock(vue.unref(index$1.ElScrollbar), {
                ...
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList(timeList.value[item], (disabled, key) => {
                      return vue.openBlock(), vue.createElementBlock("li", {
                        key,
                        class: vue.normalizeClass([
                          vue.unref(ns).be("spinner", "item"),
                          vue.unref(ns).is("active", key === timePartials.value[item]),
                          vue.unref(ns).is("disabled", disabled)
                        ]),
                        onClick: ($event) => handleClick(item, { value: key, disabled })
                      }, [
                        item === "hours" ? (vue.openBlock(), vue.createElementBlock(
                          vue.Fragment,
                          { key: 0 },
                          [
                            vue.createTextVNode(
                              vue.toDisplayString(("0" + (_ctx.amPmMode ? key % 12 || 12 : key)).slice(-2)) + vue.toDisplayString(getAmPmFlag(key)),
                              1
                            )
                          ],
                          64
                          ...
                          [
                            vue.createTextVNode(
                              vue.toDisplayString(("0" + key).slice(-2)),
                              1
                            )
                          ],
                          64
                ...
                vue.createElementVNode(
                  ...
                  [
                    (vue.openBlock(true), vue.createElementBlock(
                      vue.Fragment,
                      null,
                      vue.renderList(arrowControlTimeList.value[item], (time, key) => {
                        return vue.openBlock(), vue.createElementBlock(
                          "li",
                          {
                            key,
                            class: vue.normalizeClass([
                              vue.unref(ns).be("spinner", "item"),
                              vue.unref(ns).is("active", time === timePartials.value[item]),
                              vue.unref(ns).is("disabled", timeList.value[item][time])
                            ])
                          },
                          [
                            vue.unref(types.isNumber)(time) ? (vue.openBlock(), vue.createElementBlock(
                              vue.Fragment,
                              { key: 0 },
                              [
                                item === "hours" ? (vue.openBlock(), vue.createElementBlock(
                                  ...
                                  [
                                    vue.createTextVNode(
                                      vue.toDisplayString(("0" + (_ctx.amPmMode ? time % 12 || 12 : time)).slice(-2)) + vue.toDisplayString(getAmPmFlag(time)),
                                      1
                                    )
                                  ],
                                  64
                                  ...
                                  [
                                    vue.createTextVNode(
                                      vue.toDisplayString(("0" + time).slice(-2)),
                                      1
                                    )
                                  ],
                                  64
...
var TimeSpinner = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\time-picker\\src\\time-picker-com\\basic-time-spinner.vue"]]);
