...
import { inputTagProps, inputTagEmits } from './input-tag2.mjs';
...
var InputTag = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\input-tag\\src\\input-tag.vue"]]);
