    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          _ctx.subTitle || _ctx.$slots["sub-title"] ? (openBlock(), createElementBlock(
            "div",
            {
              key: 1,
...
var Result = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:\\workspace-etc\\element-plus\\packages\\components\\result\\src\\result.vue"]]);
