...
var fr = {
  ...
  el: {
    ...
    colorpicker: {
      confirm: "Confirmer",
      clear: "Effacer",
      defaultLabel: "S\xE9lecteur de couleurs",
      ...
      svLabel: "Choisir la valeur de saturation et de luminosit\xE9",
      svDescription: "saturation {saturation}, luminosit\xE9 {brightness}, couleur actuelle {color}",
